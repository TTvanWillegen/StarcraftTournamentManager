...
/**
 * Creates an object for a map, containing the name of the map, the map location
 * aswell as the maximum amount of teams that can play the map.
 *
...
public class Map {
	...
	public boolean equals(Object o) {
		...
		return
			mapName != null ? mapName.equals(map.mapName) : map.mapName ==
				null;
	}
