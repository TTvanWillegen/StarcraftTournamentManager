...
/**
 * A Pool object contains multiple {@link Match}es aswell as an {@link Order} in
 * which to traverse the {@link Match}es.
 *
...
public class Pool {
	 ...
	 *
	 * @param matchOrder
	 * 	{@link Order} The order to traverse the matches through.
	 */
	...
	public boolean equals(Object o) {
		...
		Pool pool = (Pool) o;
		return Objects.equals(poolName, pool.poolName) &&
			Objects.equals(teamList, pool.teamList) &&
