...
/**
 * Provides a way to add a score to a {@link objects.match.Match}. This object contains a
 * {@link Team} aswell as a score.
 *
...
public class TeamScore {
     ...
     *
     * @param teamScore {@link TeamScore} the other {@link TeamScore} to check against
     * @return {@link boolean} *True* iff this {@link TeamScore} is higher than the provided {@link
     * TeamScore}, *False* otherwise
     */
     ...
     *
     * @param teamScore {@link TeamScore} the other {@link TeamScore} to check against
     * @return {@link boolean} *True* iff the scores in these {@link TeamScore}s is equal eachother.
     */
